"""
####################################################################################
search all files at and below a named directroy for a string ; uses the os.walk interface,rather than doing a find.find to collect names first;
similar to calling visitfile for each find.find result for "* " pattern;
"""

import os,sys
listonly=False
textexts=['.py','.pyw','.txt','.text','.c','.h'
         ]
