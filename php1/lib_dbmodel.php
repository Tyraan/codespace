...
class Db{
    public static $db = array(
        ...
        'password' => '123456',
        'dbname'=> 'Products',
       'dsn' => "mysql:host=10.5.10.19;dbname=Products",
    );
    public $connection;

    public function __construct(){$this->conncetion = new PDO(Db::$db['dsn'],Db::$db['username'],Db::$db['password']); }
    public function conncet(){ return new PDO(Db::$db['dsn'],Db::$db['username'],Db::$db['password']); }
    public function end(){ }
...
class ProductMode  extends Db{
    public function add($productArray){
        $sql1= implode(",",array_keys( $productArray));
        $sql2 = implode(",",array_values($productArray));
        $sql = "INSERT INTO products ({$sql1}) VALUES ($sql2)";
        $db->exec($sql);
    }
    public function delete(){}
}
class CategoryMode extends Db{
    public function main(){}
    public function delete(){}
}
class RelationShip extends Db{
    public function delete(){}
    public function queryByProduct(){}
